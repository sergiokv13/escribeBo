...
Campament.create(name: "Cochabamba", president_id: "3")
Campament.create(name: "La Paz", president_id: "4")
...
User.create(email:"presidente1@mail.com",password:'arsenal2012',name:'Presidente',lastname:'Consejo',demolayID:'41',role:'No Demolay',ci:'12345439', chapter_id:'1', campament_id:'1', president_aproved:true, deputy_aproved:true, oficial_aproved:true)
User.create(email:"presidente2@mail.com",password:'arsenal2012',name:'Presidente',lastname:'Consejo',demolayID:'42',role:'No Demolay',ci:'12342369', chapter_id:'1', campament_id:'1', president_aproved:true, deputy_aproved:true, oficial_aproved:true)
...
Charge.create(title:"Delegado Regional", user_id: '3')
Charge.create(title:"Presidente Consejo Consultivo", user_id: '6')

#Degrees
Degree.create(title:"Consultor", user_id:"7", chapter_id:"1", president_aproved:true, deputy_aproved:true, oficial_aproved:true)
Degree.create(title:"Consultor", user_id:"8", chapter_id:"1", president_aproved:true, deputy_aproved:true, oficial_aproved:true)
Degree.create(title:"Consultor", user_id:"9", chapter_id:"1", president_aproved:true, deputy_aproved:true, oficial_aproved:true)
