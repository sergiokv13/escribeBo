...
class AnnouncementsControllerTest < ActionController::TestCase
  ...
  test "should create announcement" do
    assert_difference('Announcement.count') do
      post :create, announcement: { content: @announcement.content, subject: @announcement.subject, user_id: @announcement.user_id }
    end
  ...
  test "should update announcement" do
    patch :update, id: @announcement, announcement: { content: @announcement.content, subject: @announcement.subject, user_id: @announcement.user_id }
    assert_redirected_to announcement_path(assigns(:announcement))
  end
