...
class InboxesControllerTest < ActionController::TestCase
  ...
  test "should create inbox" do
    assert_difference('Inbox.count') do
      post :create, inbox: { content: @inbox.content, subject: @inbox.subject, user1_id: @inbox.user1_id, user2_id: @inbox.user2_id }
    end
  ...
  test "should update inbox" do
    patch :update, id: @inbox, inbox: { content: @inbox.content, subject: @inbox.subject, user1_id: @inbox.user1_id, user2_id: @inbox.user2_id }
    assert_redirected_to inbox_path(assigns(:inbox))
  end
